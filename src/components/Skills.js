...
const Skills = () => {
  const [showGitHubSkills, setShowGitHubSkills] = useState(true);
  ...
  const SkillBar = ({ skill, isGitHubData = false }) => (
    <div className="mb-4">
      ...
      <div className="w-full bg-gray-200 rounded-full h-2">
        <div
          className={`h-2 rounded-full transition-all duration-1000 ease-out ${isGitHubData
              ? "bg-gray-600"
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center items-center space-x-4 mb-8">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${showGitHubSkills ? "bg-primary-600" : "bg-gray-300"
                }`}
              disabled={!CONFIG.github.enableIntegration}
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${showGitHubSkills ? "translate-x-6" : "translate-x-1"
                  }`}
              />
            </button>
